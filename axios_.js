...
function getData() {
    ...
    //     .catch(() => console.log("Get request complated"))
...
function ayniAndaIstekData(){
    axios.all([
        ...
        sonucuEkranaYazdir(postlar,)
    }))
}



/*interceptors -> araya girme işlemleri*/
axios.interceptors.request.use(config=>{
    console.log(`${config.url} adresine ${config.method} isteği yapildi ve timeout olarak ${config.timeout} ayarlandı`);
    return config;
});
